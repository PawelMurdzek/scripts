...
if __name__ == "__main__":
    print("--- XOR Encrypter ---")
    print("XOR encryption can use single-byte keys or repeating multi-byte keys.")
    ...
    while True:
        ...
        if choice == "1":
            ...
            try:
                ...
                try:
                    printable_text = encrypted.decode('utf-8', errors='ignore')
                    if any(32 <= ord(c) <= 126 for c in printable_text):
                        print(f"Encrypted message (text): {printable_text}")
                except:
                    pass
                break
